	...
	*/
	public static int initialFileCheck()
	{
		...
		try {
			...
			br = new BufferedReader(new FileReader("mackawa2/source_mackawa/config.txt"));
	...
	*/
	public static int isMultipleCS()
	{
		...
		try {
			...
			br = new BufferedReader(new FileReader("mackawa2/source_mackawa/checkFile.txt"));
			while ((sCurrentLine = br.readLine()) != null) {
